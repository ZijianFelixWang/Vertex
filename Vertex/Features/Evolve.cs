...
namespace Vertex.Features
{
    static class Evolve
    {
        ...
        public static void StartEvolve(string EnvConf)
        {
...
#if DEBUG && __SHOW_COMPLETE_XML__
...
#if __READKEY_AFTER_INITIALIZING_DYNAMICVIEWER__ && DEBUG
                Console.ReadKey();
#endif
            }
...
#if __PRINT_UNSUCCESSFUL_CURRULE__ && DEBUG
...
#if __SAVE_EVERY_STEP_SVG__ && DEBUG && __USE_ASPOSE_API__
